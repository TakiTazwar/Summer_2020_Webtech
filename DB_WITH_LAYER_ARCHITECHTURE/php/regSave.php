	...
	if($Name!="Invalid Name")
	{
		...
		if (isset($_POST['submit'])) 
		{
			if(!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['username']) && !empty($_POST['password']) && !empty($_POST['confirmpassword']) && !empty($_POST['usertype']) && !empty($_POST['username']))
			{
				...
				{
					echo "Empty Values Cannot be entered <br>".'<a href="../views/registration.html"><u>Return</a>';
				}
			}
	}
	else
	{
		echo "Name Must be in A-Z or a-z  <br>".'<a href="../views/registration.html"><u>Return</a>';
	}
}
else
{
